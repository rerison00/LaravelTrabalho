        ...
        <div class="content">
            ...
            <div class="container-noticias">
                <div class="noticias">
                    ...
                    <p>05/02/2012</p>
                    <p style="margin-top: 10px">A data, que faz parte do movimento da reforma psiquiátrica no Brasil, tem como principal propósito combater o estigma e a exclusão enfrentados pelas pessoas que sofrem de transtornos psíquicos graves, assegurando-lhes direitos e rejeitando a imposição de tratamentos questionáveis em seu nome.</p>
                </div>
                <div class="noticias">
                    <img src="{{ asset('img/img-antimanicomial.jpg') }}" alt="">
                    <h2 class="text-title-noticias">DIA DA LUTA ANTIMANICOMIAL</h2>
